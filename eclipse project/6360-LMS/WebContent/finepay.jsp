...
<html>
  ...
  <body>
	...
	<%
		...
		// 
		String cardNo=request.getParameter("fnpaycardno");
		String sqlcmd1 = "UPDATE FINES AS F JOIN BOOK_LOANS AS BL ON BL.Loan_id=F.Loan_id AND F.paid='0'AND (BL.Date_in IS NOT NULL) AND Card_no='" + cardNo + "' SET F.paid='1';";
	...
	<div class="container">
	  ...
	  <div class="alert alert-success container" role="alert">
    	<strong>SUCCESS!</strong> The Fine has been paid.
  	  </div>
	</div>	<!-- /.container -->
